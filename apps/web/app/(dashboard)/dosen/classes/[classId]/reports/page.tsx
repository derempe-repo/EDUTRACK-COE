            ...
            <div className="p-4 sm:p-5">
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                <form action={generateClassExportAction}>
                  ...
                  <SubmitButton
                    className="inline-flex w-full items-center justify-center gap-2 rounded-md bg-teal-700 px-3 py-2.5 text-sm font-semibold text-white transition hover:bg-teal-800"
                ...
                <form action={generateClassExportAction}>
                  ...
                  <SubmitButton
                    className="inline-flex w-full items-center justify-center gap-2 rounded-md border border-teal-200 bg-white px-3 py-2.5 text-sm font-semibold text-teal-800 transition hover:bg-teal-50"
                    pendingLabel="Membuat PDF..."
                  >
